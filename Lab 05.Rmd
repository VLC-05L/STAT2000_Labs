...
## 5.3 Learning Recall Revisted

#### 1. In Exercise 5.1, there was no question on testing the assumptions of the two-way ANOVA. Using the *Lab 05 - Recall.sav* data set, test the assumptions when a two-way ANOVA is fitted. 
...
#### 2. One of the assumptions should have failed. Transform the response variable and re-run the model using the new response variable. 
