...
There does appear to be a linear relationship between the two variables. This is statistically significant (p=0.0001). This is suggesting multicollinearity. 
...
```{r}
dataWithout5 <- data[-5,]
lm(Survival1 ~ Liver1 + Enzyme1 + LiverC:EnzymeC, dataWithout5)
```
