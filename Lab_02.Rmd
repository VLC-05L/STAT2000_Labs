...
```{r include=FALSE}
S_files = list.files(pattern='02_S_.*')
...
zip::zipr(zipfile = "Lab_02_Additional_Files.zip", files = S_files)
xfun::embed_file("Lab_02_Additional_Files.zip")
```  
...
#### Identify who may be interested in such results. {-}
...
#### Comment on the two related studies that are reported in this paper. Among other things, you should consider the following: {-}
...
#### What groups are being compared in this study? Is this an experimental or an observational study? {-}
...
#### What response variables are being used as the basis for the comparison? Are they clearly defined? {-}
...
#### Apart from these response variables and the nominal explanatory variable defining the comparison groups, what other variables are considered in this study and why? {-}
...
#### The phrase "clinical significance" is used in the abstract. What does this mean? Is this the same as "statistical significance"? {-}
...
## Project Discussion – forming teams
...
This is an experimental study as the roles (levels of the predictor variable, perceived status of the intruder) were randomly allocated, and the effect on the response, whether the subject moved his/her chair away from the person potentially intruding on the subject's personal space, was recorded.
...
#### Identify the confounding variable and explain why it is a threat to the study’s internal validity. {-}
...
#### What specific control technique(s) should the investigator have employed in order to protect the internal validity of this study? {-}
